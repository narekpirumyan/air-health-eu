...
-- PostgreSQL Version - Multi-Fact Table Design
-- ============================================
-- 
...
CREATE TABLE IF NOT EXISTS dim_geography (
    ...
    nuts_id VARCHAR(50) NOT NULL UNIQUE,
    nuts_label TEXT,
...
CREATE TABLE IF NOT EXISTS dim_time (
    ...
    year_label VARCHAR(10),  -- e.g., "2020"
...
CREATE TABLE IF NOT EXISTS dim_sector (
    ...
    sector_code VARCHAR(100) NOT NULL UNIQUE,  -- Original sector name (e.g., "Agriculture", "Buildings")
    sector_name TEXT NOT NULL,  -- Human-readable name
    sector_group VARCHAR(50) NOT NULL,  -- Grouped category (agriculture, buildings, energy, industry, transport, waste)
...
CREATE TABLE IF NOT EXISTS dim_gas (
    ...
    gas_code VARCHAR(20) NOT NULL UNIQUE,  -- Gas code (e.g., "CO2", "CH4", "N2O", "F-gas")
    gas_name TEXT NOT NULL,  -- Full gas name
    gas_formula VARCHAR(20),  -- Chemical formula (e.g., "CO₂", "CH₄", "N₂O")
...
CREATE TABLE IF NOT EXISTS dim_icd10_cod (
    icd10_cod_id SERIAL PRIMARY KEY,
    icd10_code VARCHAR(50) NOT NULL UNIQUE,  -- ICD-10 code (e.g., "J", "J09-J11", "J12-J18")
    icd10_name TEXT NOT NULL,  -- Human-readable name
    icd10_category VARCHAR(50),  -- Category grouping (e.g., "respiratory", "all_respiratory")
...
CREATE TABLE IF NOT EXISTS dim_discharge_type (
    discharge_type_id SERIAL PRIMARY KEY,
    discharge_code VARCHAR(50) NOT NULL UNIQUE,  -- ICD-10 code (e.g., "J", "J00-J11", "J12-J18")
    discharge_name TEXT NOT NULL,  -- Human-readable name
    discharge_category VARCHAR(50),  -- Category grouping (e.g., "respiratory", "all_respiratory")
...
CREATE OR REPLACE VIEW vw_emissions AS
SELECT 
    g.nuts_id,
    g.nuts_label,
    g.nuts_level,
...
CREATE OR REPLACE VIEW vw_health_metrics AS
SELECT 
    g.nuts_id,
    g.nuts_label,
    g.nuts_level,
...
CREATE OR REPLACE VIEW vw_hospital_discharges AS
SELECT 
    g.nuts_id,
    g.nuts_label,
    g.nuts_level,
